...
$page = $_GET['page'] ?? 'home';
$allowed_pages = ['home', 'about', 'sign_up', 'store', 'cart', 'payment', 'user', 'product', 'order_success', 'order_detail','email_sent', 'verified', 'unverified', 'error'];
...
$page_titles = [
    ...
    'unverified' => 'Email Unverified | Venusia',
