<div class="main-container">
  ...
  <main class="container">
    ...
    <section id="team">
      ...
      <p class="content">The passionate individuals behind Venusia's digital presence and innovative solutions</p>
      <div class="team">
        <div class="member">
          ...
          <p>
            Kim specializes in user experience research and implements beautiful, functional interfaces that bring the Venusia brand to life online.
          </p>
          <div class="social-links">
            <a href="#"><i class="fab fa-linkedin-in" aria-label="LinkedIn Profile"></i></a>
            <a href="#"><i class="fab fa-twitter" aria-label="Twitter Profile"></i></a>
    ...
    <section class="stats-section">
      <div class="stats-container">
        ...
        <div class="stat-item">
          <div class="stat-number" data-target="150">101</div>
          <div class="stat-label">Unique Pieces</div>
        </div>
        <div class="stat-item">
          <div class="stat-number" data-target="100">15</div>
